...
class OpencodeGoModelProvider(UncheckedBaseModel):
    auth: ModelProviderAuth
    base_url: typing.Optional[str] = pydantic.Field(default="https://opencode.ai/zen/go/v1")
    """
    ...
    type: typing.Literal["opencode-go"] = "opencode-go"
